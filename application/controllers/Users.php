...
class Users extends CI_Controller
{
    ...
    public function profile()
    {
        ...
        if (!isset($ceks)) {
            ...
            $data['judul_web'] = "Profil | Aplikasi Sistem Kerja Praktik";
...
$no++;
    ...
    public function info($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 't') {
                ...
                $p = 'info/info_tambah';
                $data['judul_web'] = "Tambah Informasi | Aplikasi Kerja Praktik";

            } elseif ($aksi == 'e') {

                $p = 'info/info_edit';
                $data['judul_web'] = "Edit Informasi | Aplikasi Kerja Praktik";
                ...
                $p = 'info/info';
                $data['judul_web'] = "Kelola Informasi | Aplikasi Kerja Praktik";
    ...
    public function j_k($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 'e_kelas') {
                ...
                $data['judul_web'] = "Edit Kelas | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'e_jurusan') {
                $p = "j_k/j_k_edit";

                $data['query'] = $this->db->get_where("tbl_jurusan", "kdjurusan = '$id'")->row();
                $data['judul_web'] = "Edit Jurusan | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'h') {
                ...
                $data['judul_web'] = "Jurusan & Kelas | Aplikasi Kerja Praktik";
            }
    ...
    public function pengguna($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 't_pemb') {
                ...
                $data['judul_web'] = "Tambah Pembimbing | Aplikasi Kerja Praktik";
            } elseif ($aksi == 't_siswa') {
                $p = "pengguna/pengguna_tambah";

                $data['judul_web'] = "Tambah Siswa | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'd_pemb') {
                $p = "pengguna/pengguna_detail";

                $data['query'] = $this->db->get_where("tbl_pemb", "kdpemb = '$id'")->row();
                $data['judul_web'] = "Detail Pembimbing | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'd_siswa') {
                $p = "pengguna/pengguna_detail";

                $data['query'] = $this->db->get_where("tbl_siswa", "nis = '$id'")->row();
                $data['judul_web'] = "Detail Siswa | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'h_pemb') {
                ...
                $data['judul_web'] = "Pengguna | Aplikasi Kerja Praktik";
    ...
    public function industri($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 't') {
                ...
                $data['judul_web'] = "Tambah Industri | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'd') {
                $p = "industri/industri_detail";

                $data['query'] = $this->db->get_where("tbl_industri", "kdind = '$id'")->row();
                $data['judul_web'] = "Detail Industri | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'e') {
                $p = "industri/industri_edit";

                $data['query'] = $this->db->get_where("tbl_industri", "kdind = '$id'")->row();
                $data['judul_web'] = "Edit Industri | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'h') {
                ...
                $data['judul_web'] = "Industri | Aplikasi Kerja Praktik";
            }
    ...
    public function penempatan($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 'd') {
                ...
                $data['judul_web'] = "Detail Penempatan | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'h') {
                ...
                $data['judul_web'] = "Penempatan | Aplikasi Kerja Praktik";
            }
    ...
    public function nilai_praktik($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 'd') {
                ...
                $data['judul_web'] = "Detail Nilai | Aplikasi Kerja Praktik";
            } else {
                $p = "nilai/nilai";

                $data['judul_web'] = "Nilai | Aplikasi Kerja Praktik";
            }
    ...
    // pal2019
    public function status_pendaftaran($aksi = '', $id = '')
    {
        $ceks = $this->session->userdata('prakrin_smk@Proyek-2017');
        $id_user = $this->session->userdata('id_user@Proyek-2017');
        $level = $this->session->userdata('level@Proyek-2017');
        if (!isset($ceks)) {
            ...
            $data['user'] = $this->Mcrud->get_users_by_un($ceks);
            $data['v_status_pendaftaran'] = $this->db->get('tbl_status_pendaftaran');
            $data['email'] = '';
            $data['level'] = 'Admin';

            if ($aksi == 'e') {
                $p = "status_pendaftaran/status_pendaftaran_edit";

                $data['query'] = $this->db->get_where("tbl_status_pendaftaran", "id = '$id'")->row();
                $data['judul_web'] = "Edit Status Pendaftaran | Aplikasi Kerja Praktik";
            } else {
                $p = "status_pendaftaran/status_pendaftaran";

                $data['judul_web'] = "Status Pendaftaran | Aplikasi Kerja Praktik";
            }
            ...
            if (isset($_POST['btnupdate'])) {
                ...
                $this->db->update('tbl_status_pendaftaran', $data, "id='$id'");
                ...
                $this->session->set_flashdata('msg',
                    '
							<div class="alert alert-success alert-dismissible" role="alert">
								 ...
								 <strong>Sukses!</strong> Status pendaftaran berhasil diperbarui.
							</div>'
                );
                redirect('users/status_pendaftaran');
            }
        }
    }
    ...
    public function d_siswa($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 'd') {
                ...
                $data['judul_web'] = "Data Siswa | Aplikasi Kerja Praktik";
            }
    ...
    public function bimbingan($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 't') {
                ...
                $data['judul_web'] = "Tambah Bimbingan | Aplikasi Kerja Praktik";
                $this->db->order_by('nis', 'DESC');
                $this->db->order_by('nama_lengkap', 'ASC');
                $this->db->where('kdpemb', $pembimbing);
                $data['v_siswa'] = $this->db->get('tbl_siswa');
                ...
                $data['judul_web'] = "Detail Bimbingan | Aplikasi Kerja Praktik";
            } elseif ($aksi == 'h') {
                ...
                $data['judul_web'] = "Data Bimbingan | Aplikasi Kerja Praktik";
            }
    ...
    public function nilai($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            if ($aksi == 't') {
                ...
                $data['judul_web'] = "Data Nilai | Aplikasi Kerja Praktik";
            }
...
//---------------------------- Siswa ----------------------------//
    public function status_prakerin($aksi = '', $id = '')
    {
        ...
        if (!isset($ceks)) {
            ...
            $cek_waktu = $this->db->get_where('tbl_penempatan', array('kdpenempatan' => "5"));
            ...
            if ($aksi == 't') {
                ...
                // pal2019
                $data['status_pendaftaran'] = $this->db->get("tbl_status_pendaftaran")->row()->status;
            }
    ...
    public function buat_bimbingan($aksi = '', $id = '')
    {
        $ceks = $this->session->userdata('prakrin_smk@Proyek-2017');
        $id_user = $this->session->userdata('id_user@Proyek-2017');
        $level = $this->session->userdata('level@Proyek-2017');
        if (!isset($ceks)) {
			...
			$pembimbing = $this->model->findData('tbl_pemb', 'nip', $id_user)->row()->kdpemb;
            $data['v_bimbingan'] = $this->db->get('tbl_bimbingan');
			$data['v_siswa']=$this->db->where('kdpemb', $pembimbing)->from('tbl_siswa')->get();
            $data['email'] = '';
            $data['level'] = 'Siswa';
    ...
    public function monitoring()
    {
        ...
        if (!isset($ceks)) {
            ...
            $data['judul_web'] = "Monitoring | Aplikasi Kerja Praktik";
