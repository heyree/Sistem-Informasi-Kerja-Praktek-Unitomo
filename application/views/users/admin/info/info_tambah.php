        ...
        <div class="panel-body">
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="col-sm-12 pull-left" style="margin-top: 10px;">
              ...
              <textarea class="form-control summernote" id="deskripsi" name="deskripsi" rows="11" cols="80" placeholder="Deskripsi" required></textarea>
            </div>
            <div class="col-sm-12 pull-left" style="margin-top: 0px;">
              <label for="gambar"><b>Gambar</b></label>
              <input type="file" class="form-control" id="gambar" name="gambar" value="" placeholder="Gambar" required>
